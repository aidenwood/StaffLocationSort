...
import { usePipedriveDataV4 } from '../hooks/usePipedriveDataV4.js';

const InspectionDashboardV4 = () => {
  ...
  // Use Pipedrive V4 data (Raw Calendar Data - No Filters) - fetch for selected inspector only
  const { 
    activities, 
    ...
    isTimeout,
    fetchActivities 
  } = usePipedriveDataV4({ autoFetch: false }); // Don't auto-fetch, we'll fetch when inspector changes
...
export default InspectionDashboardV4;