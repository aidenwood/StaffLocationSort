...
import { usePipedriveDataV2 } from '../hooks/usePipedriveDataV2.js';

const InspectionDashboardV2 = () => {
  ...
  // Use Pipedrive V2 data (Filters API) - fetch for selected inspector only
  const { 
    activities, 
    ...
    isTimeout,
    fetchActivities 
  } = usePipedriveDataV2({ autoFetch: false }); // Don't auto-fetch, we'll fetch when inspector changes
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">
              Inspection Scheduler V2
            </h1>
            <p className="text-gray-600 text-sm">
              V2: Pipedrive Filters API - Manage home inspections for Logan, QLD area
            </p>
          </div>
...
export default InspectionDashboardV2;